...
public partial class ManageShortcutsViewModel : ObservableObject
{
    ...
    public ObservableCollection<ShortcutEntryViewModel> Entries { get; } = new DataGridObservableCollection<ShortcutEntryViewModel>();

    public ObservableCollection<StartMenuShortcutEntryViewModel> StartMenuEntries { get; } = new DataGridObservableCollection<StartMenuShortcutEntryViewModel>();
